...
static void createModuleConstants(void) {
    loadConstantsBlob(&mod_consts[0], "numpy.matrixlib");
...
static PyCodeObject *codeobj_db9c7c18091440abe99db859ce1db815;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(mod_consts[27]); CHECK_OBJECT(module_filename_obj);
    codeobj_db9c7c18091440abe99db859ce1db815 = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[28], NULL, NULL, 0, 0, 0);
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_db9c7c18091440abe99db859ce1db815;
    ...
    // Frame without reuse.
    frame_db9c7c18091440abe99db859ce1db815 = MAKE_MODULE_FRAME(codeobj_db9c7c18091440abe99db859ce1db815, module_numpy$matrixlib);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_db9c7c18091440abe99db859ce1db815);
    assert(Py_REFCNT(frame_db9c7c18091440abe99db859ce1db815) == 2);
    ...
    // Framed code:
    {
        ...
        frame_db9c7c18091440abe99db859ce1db815->m_frame.f_lineno = 1;
        {
    ...
    }
    {
        ...
        frame_db9c7c18091440abe99db859ce1db815->m_frame.f_lineno = 4;
    ...
    }
    {
        ...
        frame_db9c7c18091440abe99db859ce1db815->m_frame.f_lineno = 8;
    ...
    }
    {
        ...
        frame_db9c7c18091440abe99db859ce1db815->m_frame.f_lineno = 9;
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_db9c7c18091440abe99db859ce1db815);
#endif
    popFrameStack();

    assertFrameObject(frame_db9c7c18091440abe99db859ce1db815);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_db9c7c18091440abe99db859ce1db815, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_db9c7c18091440abe99db859ce1db815->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_db9c7c18091440abe99db859ce1db815, exception_lineno);
    }
