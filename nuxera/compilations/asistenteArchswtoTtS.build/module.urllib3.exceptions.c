...
// Mark the execution in the "__spec__" value.
    ...
    // Tried code:
    {
...

        {
            ...
            tmp_assign_source_254 = impl___main__$$$function__4__mro_entries_conversion(dir_call_args);
        }
    ...
    }
    {
...

        {
            ...
            tmp_assign_source_262 = impl___main__$$$function__4__mro_entries_conversion(dir_call_args);
        }
    ...
    }
    {
...

        {
            ...
            tmp_assign_source_270 = impl___main__$$$function__4__mro_entries_conversion(dir_call_args);
        }
