...
static void createModuleConstants(void) {
    loadConstantsBlob(&mod_consts[0], "scipy.version");
...
NUITKA_MAY_BE_UNUSED static char const *module_full_name = "scipy.version";
...
PyObject *modulecode_scipy$version(PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *module_entry) {
    ...
    if (_init_done) {
#ifdef _NUITKA_TRACE
        PRINT_STRING("scipy.version: Skipping module init, already done.\n");
#endif
