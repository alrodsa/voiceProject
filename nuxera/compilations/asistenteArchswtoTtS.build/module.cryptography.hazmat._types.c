...
static void createModuleConstants(void) {
    loadConstantsBlob(&mod_consts[0], "cryptography.hazmat._types");
...
NUITKA_MAY_BE_UNUSED static char const *module_full_name = "cryptography.hazmat._types";
...
PyObject *modulecode_cryptography$hazmat$_types(PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *module_entry) {
    ...
    if (_init_done) {
#ifdef _NUITKA_TRACE
        PRINT_STRING("cryptography.hazmat._types: Skipping module init, already done.\n");
#endif
