...
static void createModuleConstants(void) {
    loadConstantsBlob(&mod_consts[0], "colorama");
...
NUITKA_MAY_BE_UNUSED static char const *module_full_name = "colorama";
...
PyObject *modulecode_colorama(PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *module_entry) {
    ...
    if (_init_done) {
#ifdef _NUITKA_TRACE
        PRINT_STRING("colorama: Skipping module init, already done.\n");
#endif
