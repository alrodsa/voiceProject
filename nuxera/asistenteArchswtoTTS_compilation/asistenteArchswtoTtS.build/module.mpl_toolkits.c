...
static void createModuleConstants(void) {
    loadConstantsBlob(&mod_consts[0], "mpl_toolkits");
...
NUITKA_MAY_BE_UNUSED static char const *module_full_name = "mpl_toolkits";
...
PyObject *modulecode_mpl_toolkits(PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *module_entry) {
    ...
    if (_init_done) {
#ifdef _NUITKA_TRACE
        PRINT_STRING("mpl_toolkits: Skipping module init, already done.\n");
#endif
