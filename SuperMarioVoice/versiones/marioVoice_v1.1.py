...
def realizarAccion(speech):
    ...
    if 'saltar' in speech or 'salta' in speech:
        print("-> SALTAR")
        keyboard.press('x')
        sleep(0.5)
        keyboard.release('x')

    if 'derecha' in speech:
        if keyboard.is_pressed('left arrow'):
            keyboard.release('left arrow')
        print("-> DERECHA")
        keyboard.press('right arrow')
    
    if 'parar' in speech or 'para' in speech:
        print("-> PARAR")
    ...
    if 'izquierda' in speech:
        if keyboard.is_pressed('right arrow'):
            keyboard.release('right arrow')
            print("-> IZQUIERDA")
        keyboard.press('left arrow')
    
    if 'correr' in speech or 'corre' in speech:
        print("-> CORRER")
        keyboard.press('a')
